...
public class ReservaTest {
    ...
    public void testVerificarCupo() {
        ...
        Reserva test = new Reserva();
        boolean cupo = test.verificarCupo(new Conferencia(10));
    ...
    public void testGuardarReserva() {
        ...
        Reserva test = new Reserva();
        boolean reserva = test.guardarReserva(5, 6, "29/11/2014", "Reservado");
    ...
    public void testEnviarEmail() {
        ...
        boolean mailenviado = test.enviarEmail("to.danielrp@gmail.com", "Mail de"
                + " Confirmacion", test.crearEmail("Drupal Camp", "3/01/2015", "Cochabamba", "Av. Portales 1022", 250));
